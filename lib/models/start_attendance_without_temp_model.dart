class StartAttendanceWithoutTempResponse {
  ...
  StartAttendanceWithoutTempResponse({
  ...
  factory StartAttendanceWithoutTempResponse.fromJson(Map<String, dynamic> json) {
    return StartAttendanceWithoutTempResponse(
